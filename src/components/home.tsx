...
export default function Home({ onGetQuote }: { onGetQuote: () => void }) {
  return (
          ...
          {[
            ...
            <div key={idx} className="bg-[#FDFDFD] pb-4">
              <Image
                alt={project.title}
                src={project.img}
                className={`max-h-50 w-full object-cover ${project.bg} mb-4 flex items-center justify-center text-sm text-gray-400`}
              />
              <div className="px-4">
